...
import { Container, LayoutDashboard, Box, LogOut, Moon, Sun, Sparkles } from "lucide-react"
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/80 backdrop-blur-md">
      <div className="flex h-14 items-center px-4 lg:px-6">
        <Link to="/dashboard" className="flex items-center gap-2 font-semibold mr-8">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground">
            <Container className="h-4 w-4" />
          </div>
          <span className="hidden sm:inline">SaaS Orchestrator</span>
        </Link>
